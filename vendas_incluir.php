<html>
    <head>
        <title>Inclusão de Vendas</title>
    ...
    <body>
        ...
        <div class="container">
            <form action="incluir_produtos.php" method="post">
                ...
                <input type="text" nome="nome_usuario" id="nome_usuario" class="form-control" required>
                <!-- required torna o campo obrigatorio -->
                <label>E-mail</label>
                <input type="qtde_estoque" name="qtde_estoque" id="qtde_estoque" class="form-control"> 
                <!-- type= "qtde_estoque"-->
